...
def doit(filename=None, output_filename=None, hide_gui=False):
    ...
    ufmf_writer = ufmf_mod.UfmfSaverV2(
        output_filename,
...
def main():
    ...
    parser.add_option("--hide-gui", action="store_true", default=False)
    ...
    doit(
        filename=filename, output_filename=output_filename, hide_gui=options.hide_gui,
    )
